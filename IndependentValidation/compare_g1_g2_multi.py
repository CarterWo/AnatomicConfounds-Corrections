...
MODELS = {
    "dream_blind":    ("Local_Regional_Analysis", "INDEP_MULTI_{scenario}_dream_blind.csv"),
    "dream_napari":   ("Global_CT_Analysis",       "INDEP_MULTI_{scenario}_dream_napari.csv"),
    "dream_quint":    ("Global_CT_Analysis",       "INDEP_MULTI_{scenario}_dream_quint.csv"),
    "seurat_blind":   ("Global_CT_Analysis",       "INDEP_MULTI_{scenario}_seurat_blind.csv"),
    "seurat_napari":  ("Global_CT_Analysis",       "INDEP_MULTI_{scenario}_seurat_napari.csv"),
    "seurat_quint":   ("Global_CT_Analysis",       "INDEP_MULTI_{scenario}_seurat_quint.csv"),
    "wilcoxon":       ("Global_CT_Analysis",       "INDEP_MULTI_{scenario}_wilcoxon.csv"),
    "deseq2_pb":      ("Pseudobulk_Validation",    "DESEQ2INDEP_MULTI_{scenario}_PB.csv"),
}
