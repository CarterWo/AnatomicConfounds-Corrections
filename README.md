...
**1e. Import R embeddings**

After clustering in Seurat, read the updated metadata, UMAP, and PCA back into Python and join them to `adata_full.obs`/`.obsm`.

**1f. Assign anatomical regions**
...
**1h. Create region-enriched subsets** (stroke manuscript specific)
